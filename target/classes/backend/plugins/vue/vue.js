...
(function (global, factory) {
  ...
  function createFunctionalComponent (
    ...
    if (vnode instanceof VNode) {
      return cloneAndMarkFunctionalR(vnode, data, renderContext.parent, options, renderContext)
    } else if (Array.isArray(vnode)) {
      var vnodes = normalizeChildren(vnode) || [];
      var res = new Array(vnodes.length);
      for (var i = 0; i < vnodes.length; i++) {
        res[i] = cloneAndMarkFunctionalR(vnodes[i], data, renderContext.parent, options, renderContext);
      }
      return res
    }
  }

  function cloneAndMarkFunctionalR (vnode, data, contextVm, options, renderContext) {
